...
pub struct ServiceConfig {
    ...
    /// Whether converge should restart this service if probes fail.
    /// Defaults to the value in `defaults.restart_on_fail` (true).
...
pub struct DefaultsConfig {
    ...
    #[serde(default = "default_restart_on_fail")]
    pub restart_on_fail: bool,
}

fn default_restart_on_fail() -> bool {
    true
}
...
impl Default for DefaultsConfig {
    fn default() -> Self {
        Self {
            ...
            restart_on_fail: default_restart_on_fail(),
        }
    }
}
